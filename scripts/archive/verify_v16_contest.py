#!/usr/bin/env python3
"""
verify_v16_contest.py — IONIS V16 Combined Physics Verification
...
V16 uses per-source per-band Z-score normalization. Model outputs are in σ units.
...
class IonisV12Gate(nn.Module):
    """V16 uses same architecture as V12 (IonisV12Gate)."""
...
def test_physics():
    ...
    print()
    print(f"  NOTE: V16 outputs are in Z-score (σ) units.")
    ...
    if all_pass:
        ...
        print()
        print("  V16 Combined Model Physics:")
        ...
        print()
        print("  V16 trained on WSPR + RBN DXpedition signatures (152 rare DXCC entities)")
    else:
