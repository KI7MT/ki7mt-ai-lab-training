import torch
import numpy as np
from train_v7_lobotomy import IonisMish  # Import Phase 7 model class

# --- CONFIG ---
MODEL_PATH = "models/ionis_v7_lobotomy.pth"
...
def get_test_vector(kp_value):
    ...
    features = [
        ...
        # kp REMOVED — no raw kp feature
        0.5,    # band_sfi_interact
        0.5,    # sfi_dist_interact
        kp_penalty # THE ONLY Kp CHANNEL (Index 16)
    ]
...
def test_physics():
    ...
    model = IonisMish(input_dim=17).to(DEVICE)
    ...
    print("Phase 7: Raw kp removed, kp_penalty only")
    print("-" * 40)
    ...
    if diff > 0:
        ...
        print("The Monotonic Constraint worked. The backdoor is closed.")
    else:
