#!/usr/bin/env python3
"""
test_v16_contest.py — IONIS V16 Combined Sensitivity Analysis

V16 outputs in Z-normalized units (σ). Reports both σ and approximate dB.
...
print(f"\n{'='*70}")
print(f"  IONIS V16 Combined — SNR Sensitivity Analysis")
