#!/usr/bin/env python3
"""
validate_v14_tp_v2_step_i.py — V14-TP-v2 vs VOACAP comparison on Step I paths

Queries 1M contest paths from validation.step_i_paths, runs V14-TP-v2 inference,
denormalizes to dB, applies mode thresholds, and reports recall.

V14-TP-v2: Terrestrial Physics with corrected balloon filter (93.3M signatures).
...
MODEL_PATH = os.path.join(TRAINING_DIR, "models", "ionis_v15_diamond.pth")
...
def main():
    print("=" * 70)
    print("  IONIS V13 Step I Redux — VOACAP Comparison")
    print("=" * 70)
    print()
    ...
    print(f"  V13 Recall:      {recall:.2f}%")
    print()
    print("  Baselines:")
    print(f"    VOACAP:        75.82%")
    print(f"    IONIS V12:     90.40%")
    print()

    delta_voacap = recall - 75.82
    delta_v12 = recall - 90.40
    print(f"  V13 vs VOACAP:   {delta_voacap:+.2f} pp")
    print(f"  V13 vs V12:      {delta_v12:+.2f} pp")
    print()
